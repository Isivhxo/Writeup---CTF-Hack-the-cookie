...
![Lab HackerDNA prêt, avec l'URL cible du portail TechCorp](images/01-lab-target.png)
...
![Page de connexion du portail TechCorp Internal Portal](images/02-login-page.png)

![Tableau de bord invité avec accès restreint](images/03-dashboard-guest.png)
...
![Ouverture du menu du navigateur pour accéder aux outils de développement](images/04-devtools-menu.png)

![Accès à « Web Developer Tools » depuis le sous-menu « More tools »](images/05-devtools-webtools.png)
